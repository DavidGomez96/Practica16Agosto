...
public class Circulo extends FiguraGeometrica {
    ...
    public Circulo(double radio) throws MagnitudNegativoException {
        setColor("blanco");
        if(radio >= 0) {
            this.radio = radio;
        } else {
            throw new MagnitudNegativoException();
        }
    }
    ...
    public void setRadio(double radio) throws MagnitudNegativoException {
        if(radio >= 0) {
            this.radio = radio;
        } else {
            throw new MagnitudNegativoException();
